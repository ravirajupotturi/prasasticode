...
// File: contracts\EQ8dex\SchoolCGPA.sol

//
pragma solidity ^0.8.0;
contract CollegeSBT is ERC721URIStorage, MinterRole {
        ...
        onlyMinter(_msgSender())
    {
        ...
        _studentSbt.TechnologyProviderCompany = "NeuralByte Digital Solution";
        _studentSbt.ProductName = "Prasasti";
        studentSbtInfo[SBT_ID] = _studentSbt;
        _setTokenURI(SBT_ID,_tokenURI);
        emit SBT_mint(admin, _to, SBT_ID,_tokenURI);
        SBT_ID++;
    }
    function updateSbtdata(uint256 _sbtId, studentSbt memory _studentSbt) external onlyMinter(_msgSender()){
